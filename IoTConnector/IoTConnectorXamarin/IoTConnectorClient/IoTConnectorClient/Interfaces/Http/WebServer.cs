...
#pragma warning restore CS4014
        ...
        private async Task SendMessages(int numMsg)
        {
            ...
            for (int i = 0; i < numMsg; i++)
            {
                if (sendMsg)
                {
                    string fullMsg = await hc.sendCoordinateMessage("android_phone");
        ...
        public void addListElement(string fullMsg)
        {
            string listElements = "<li class='msg'>" + fullMsg + "</li>\n";
            listElements = Constants.LIST_HEADER + "\n" + listElements;
            LoadandUpdateStatus(Constants.LIST_HEADER, listElements, NavConstants.DEFAULT_PAGE);
        }
        /// <summary>
