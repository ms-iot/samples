...
{
    class SensorWeatherDataProvider : IWeatherDataProvider
    {
        public static async Task<SensorWeatherDataProvider> Create()
        {
            ...
            return new SensorWeatherDataProvider(sensor);
        }

        private I2cDevice sensor;

        private SensorWeatherDataProvider(I2cDevice sensor)
        {
            this.sensor = sensor;
        }
