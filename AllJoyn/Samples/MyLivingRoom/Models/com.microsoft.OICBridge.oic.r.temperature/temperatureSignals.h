...
ref class temperatureSignals;

public interface class ItemperatureSignals
{
};

public ref class temperatureSignals sealed : [Windows::Foundation::Metadata::Default] ItemperatureSignals
{
public:
internal:
