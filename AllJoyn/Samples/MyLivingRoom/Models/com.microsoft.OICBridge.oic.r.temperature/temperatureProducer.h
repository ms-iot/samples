...
extern PCSTR c_temperatureIntrospectionXml;

ref class temperatureProducer;

public interface class ItemperatureProducer
{
    event Windows::Foundation::TypedEventHandler<temperatureProducer^, Windows::Devices::AllJoyn::AllJoynProducerStoppedEventArgs^>^ Stopped;
    event Windows::Foundation::TypedEventHandler<temperatureProducer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;
    event Windows::Foundation::TypedEventHandler<temperatureProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;
    event Windows::Foundation::TypedEventHandler<temperatureProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
};

public ref class temperatureProducer sealed : [Windows::Foundation::Metadata::Default] ItemperatureProducer
{
public:
    temperatureProducer(Windows::Devices::AllJoyn::AllJoynBusAttachment^ busAttachment);
    virtual ~temperatureProducer();

    // The implementation of ItemperatureService that will handle method calls and property requests.
    property ItemperatureService^ Service
    {
        ItemperatureService^ get() { return m_serviceInterface; }
        void set(ItemperatureService^ value) { m_serviceInterface = value; }
    }
    ...
    virtual event Windows::Foundation::TypedEventHandler<temperatureProducer^, Windows::Devices::AllJoyn::AllJoynProducerStoppedEventArgs^>^ Stopped;
    
    // This event will fire whenever the producer loses the session that it created.
    virtual event Windows::Foundation::TypedEventHandler<temperatureProducer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;
    
    // This event will fire whenever a member joins the session.
    virtual event Windows::Foundation::TypedEventHandler<temperatureProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;

    // This event will fire whenever a member leaves the session.
    virtual event Windows::Foundation::TypedEventHandler<temperatureProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;

    // Send a signal to all members of the session to notify them that the value of Range has changed.
    ...
    // Send a signal to all members of the session to notify them that the value of Units has changed.
...
private:
    ...
    ItemperatureService^ m_serviceInterface;
