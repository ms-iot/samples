...
public interface class ItemperatureConsumer
{
    event Windows::Foundation::TypedEventHandler<temperatureConsumer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;
    event Windows::Foundation::TypedEventHandler<temperatureConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;
    event Windows::Foundation::TypedEventHandler<temperatureConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
    event Windows::Foundation::TypedEventHandler<temperatureConsumer^, Platform::Object^>^ RangeChanged;
    event Windows::Foundation::TypedEventHandler<temperatureConsumer^, Platform::Object^>^ TemperatureChanged;
    event Windows::Foundation::TypedEventHandler<temperatureConsumer^, Platform::Object^>^ UnitsChanged;
};

public ref class temperatureConsumer sealed  : [Windows::Foundation::Metadata::Default] ItemperatureConsumer
{
public:
    temperatureConsumer(Windows::Devices::AllJoyn::AllJoynBusAttachment^ busAttachment);
    virtual ~temperatureConsumer();
    ...
    static Windows::Foundation::IAsyncOperation<temperatureJoinSessionResult^>^ JoinSessionAsync(_In_ Windows::Devices::AllJoyn::AllJoynServiceInfo^ serviceInfo, _Inout_ temperatureWatcher^ watcher);

    // This event fires whenever the value of Range changes.
    virtual event Windows::Foundation::TypedEventHandler<temperatureConsumer^, Platform::Object^>^ RangeChanged;
    
    // Get the value of the Range property.
    Windows::Foundation::IAsyncOperation<temperatureGetRangeResult^>^ GetRangeAsync();

    // Set the value of the Range property.
    Windows::Foundation::IAsyncOperation<temperatureSetRangeResult^>^ SetRangeAsync(_In_ Platform::String^ value);
    // This event fires whenever the value of Temperature changes.
    virtual event Windows::Foundation::TypedEventHandler<temperatureConsumer^, Platform::Object^>^ TemperatureChanged;
    
    // Get the value of the Temperature property.
    Windows::Foundation::IAsyncOperation<temperatureGetTemperatureResult^>^ GetTemperatureAsync();

    // Set the value of the Temperature property.
    Windows::Foundation::IAsyncOperation<temperatureSetTemperatureResult^>^ SetTemperatureAsync(_In_ double value);
    // This event fires whenever the value of Units changes.
    virtual event Windows::Foundation::TypedEventHandler<temperatureConsumer^, Platform::Object^>^ UnitsChanged;
    
    // Get the value of the Units property.
    Windows::Foundation::IAsyncOperation<temperatureGetUnitsResult^>^ GetUnitsAsync();

    // Set the value of the Units property.
    Windows::Foundation::IAsyncOperation<temperatureSetUnitsResult^>^ SetUnitsAsync(_In_ Platform::String^ value);

    // Used to send signals or register functions to handle received signals.
    property temperatureSignals^ Signals
    {
        temperatureSignals^ get() { return m_signals; }
    }

    // This event will fire whenever the consumer loses the session that it is a member of.
    virtual event Windows::Foundation::TypedEventHandler<temperatureConsumer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;

    // This event will fire whenever a member joins the session.
    virtual event Windows::Foundation::TypedEventHandler<temperatureConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;

    // This event will fire whenever a member leaves the session.
    virtual event Windows::Foundation::TypedEventHandler<temperatureConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
