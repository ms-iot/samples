...
void MainInterfaceWatcher::UnregisterFromBus()
{
    ...
    {
        PCSTR interfaces[] = { "com.honeywell.Thermostat.LyricAsa3demo.MainInterface" };
    ...
    _In_ const alljoyn_msgarg aboutDataArg)
{
    ...
    if (alljoyn_aboutobjectdescription_hasinterface(objectDescription, "com.honeywell.Thermostat.LyricAsa3demo.MainInterface"))
    {
        AllJoynServiceInfo^ args = ref new AllJoynServiceInfo(
            AllJoynHelpers::MultibyteToPlatformString(name),
            AllJoynHelpers::GetObjectPath(objectDescription, "com.honeywell.Thermostat.LyricAsa3demo.MainInterface"),
            port);
        Added(this, args);
    }
