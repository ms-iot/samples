...
public:
    ...
    // Call the SetTemperature method
    Windows::Foundation::IAsyncOperation<MainInterfaceSetTemperatureResult^>^ SetTemperatureAsync(_In_ double interfaceMemberTargetTemperatureTemperatureScale, _In_ int16 interfaceMemberInputArg);
    // Call the SetTemperature68 method
    Windows::Foundation::IAsyncOperation<MainInterfaceSetTemperature68Result^>^ SetTemperature68Async();
    // Call the SetTemperature70 method
    Windows::Foundation::IAsyncOperation<MainInterfaceSetTemperature70Result^>^ SetTemperature70Async();
    // Call the SetTemperature72 method
    Windows::Foundation::IAsyncOperation<MainInterfaceSetTemperature72Result^>^ SetTemperature72Async();
    // Call the SetTemperature74 method
    Windows::Foundation::IAsyncOperation<MainInterfaceSetTemperature74Result^>^ SetTemperature74Async();
