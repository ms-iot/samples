...
public interface class ImodeConsumer
{
    event Windows::Foundation::TypedEventHandler<modeConsumer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;
    event Windows::Foundation::TypedEventHandler<modeConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;
    event Windows::Foundation::TypedEventHandler<modeConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
    event Windows::Foundation::TypedEventHandler<modeConsumer^, Platform::Object^>^ ModesChanged;
    event Windows::Foundation::TypedEventHandler<modeConsumer^, Platform::Object^>^ SupportedModesChanged;
};

public ref class modeConsumer sealed  : [Windows::Foundation::Metadata::Default] ImodeConsumer
{
public:
    modeConsumer(Windows::Devices::AllJoyn::AllJoynBusAttachment^ busAttachment);
    virtual ~modeConsumer();
    ...
    static Windows::Foundation::IAsyncOperation<modeJoinSessionResult^>^ JoinSessionAsync(_In_ Windows::Devices::AllJoyn::AllJoynServiceInfo^ serviceInfo, _Inout_ modeWatcher^ watcher);

    // This event fires whenever the value of Modes changes.
    virtual event Windows::Foundation::TypedEventHandler<modeConsumer^, Platform::Object^>^ ModesChanged;
    
    // Get the value of the Modes property.
    Windows::Foundation::IAsyncOperation<modeGetModesResult^>^ GetModesAsync();

    // Set the value of the Modes property.
    Windows::Foundation::IAsyncOperation<modeSetModesResult^>^ SetModesAsync(_In_ Platform::String^ value);
    // This event fires whenever the value of SupportedModes changes.
    virtual event Windows::Foundation::TypedEventHandler<modeConsumer^, Platform::Object^>^ SupportedModesChanged;
    
    // Get the value of the SupportedModes property.
    Windows::Foundation::IAsyncOperation<modeGetSupportedModesResult^>^ GetSupportedModesAsync();

    // Set the value of the SupportedModes property.
    Windows::Foundation::IAsyncOperation<modeSetSupportedModesResult^>^ SetSupportedModesAsync(_In_ Platform::String^ value);

    // Used to send signals or register functions to handle received signals.
    property modeSignals^ Signals
    {
        modeSignals^ get() { return m_signals; }
    }

    // This event will fire whenever the consumer loses the session that it is a member of.
    virtual event Windows::Foundation::TypedEventHandler<modeConsumer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;

    // This event will fire whenever a member joins the session.
    virtual event Windows::Foundation::TypedEventHandler<modeConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;

    // This event will fire whenever a member leaves the session.
    virtual event Windows::Foundation::TypedEventHandler<modeConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
