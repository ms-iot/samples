...
public interface class IbrightnessService
{
public:
    ...
    Windows::Foundation::IAsyncOperation<brightnessGetValueResult^>^ GetValueAsync(Windows::Devices::AllJoyn::AllJoynMessageInfo^ info);

    // Implement this function to handle requests to set the Value property.
    //
    // Currently, info will always be null, because no information is available about the requestor.
    Windows::Foundation::IAsyncOperation<brightnessSetValueResult^>^ SetValueAsync(Windows::Devices::AllJoyn::AllJoynMessageInfo^ info, int64 value);
