...
public:
    ...
    // Send a signal to all members of the session to notify them that the value of Humidity has changed.
    void EmitHumidityChanged();

    // Send a signal to all members of the session to notify them that the value of Temperature has changed.
