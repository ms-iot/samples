...
// Methods
// Property Reads
IAsyncOperation<ControlPanelGetVersionResult^>^ ControlPanelServiceEventAdapter::GetVersionAsync(_In_ AllJoynMessageInfo^ info)
{
    auto args = ref new ControlPanelGetVersionRequestedEventArgs(info);
    GetVersionRequested(this, args);
    return ControlPanelGetVersionRequestedEventArgs::GetResultAsync(args);
}
