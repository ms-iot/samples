...
// Methods
// Readable Properties
ControlPanelGetVersionRequestedEventArgs::ControlPanelGetVersionRequestedEventArgs(
    _In_ AllJoynMessageInfo^ info)
    : m_raised(false),
    m_completionsRequired(0),
    m_messageInfo(info)
{
	m_result = ControlPanelGetVersionResult::CreateFailureResult(ER_NOT_IMPLEMENTED);
}

Deferral^ ControlPanelGetVersionRequestedEventArgs::GetDeferral()
{
    ...
    auto handler = ref new DeferralCompletedHandler(this, &ControlPanelGetVersionRequestedEventArgs::Complete);
    return ref new Deferral(handler);
}

void ControlPanelGetVersionRequestedEventArgs::InvokeAllFinished()
{
    bool invokeNeeded;
...
void ControlPanelGetVersionRequestedEventArgs::Complete()
{
    bool invokeNeeded;
...
void ControlPanelGetVersionRequestedEventArgs::InvokeCompleteHandler()
{
