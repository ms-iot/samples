...
ref class openlevelSignals;

public interface class IopenlevelSignals
{
};

public ref class openlevelSignals sealed : [Windows::Foundation::Metadata::Default] IopenlevelSignals
{
public:
internal:
