...
public interface class IaudioConsumer
{
    event Windows::Foundation::TypedEventHandler<audioConsumer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;
    event Windows::Foundation::TypedEventHandler<audioConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;
    event Windows::Foundation::TypedEventHandler<audioConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
    event Windows::Foundation::TypedEventHandler<audioConsumer^, Platform::Object^>^ MuteChanged;
    event Windows::Foundation::TypedEventHandler<audioConsumer^, Platform::Object^>^ VolumeChanged;
};

public ref class audioConsumer sealed  : [Windows::Foundation::Metadata::Default] IaudioConsumer
{
public:
    audioConsumer(Windows::Devices::AllJoyn::AllJoynBusAttachment^ busAttachment);
    ...
    static Windows::Foundation::IAsyncOperation<audioJoinSessionResult^>^ JoinSessionAsync(_In_ Windows::Devices::AllJoyn::AllJoynServiceInfo^ serviceInfo, _Inout_ audioWatcher^ watcher);

    // This event fires whenever the value of Mute changes.
    virtual event Windows::Foundation::TypedEventHandler<audioConsumer^, Platform::Object^>^ MuteChanged;
    
    // Get the value of the Mute property.
    Windows::Foundation::IAsyncOperation<audioGetMuteResult^>^ GetMuteAsync();

    // Set the value of the Mute property.
    Windows::Foundation::IAsyncOperation<audioSetMuteResult^>^ SetMuteAsync(_In_ bool value);
    // This event fires whenever the value of Volume changes.
    virtual event Windows::Foundation::TypedEventHandler<audioConsumer^, Platform::Object^>^ VolumeChanged;
    
    // Get the value of the Volume property.
    Windows::Foundation::IAsyncOperation<audioGetVolumeResult^>^ GetVolumeAsync();

    // Set the value of the Volume property.
    Windows::Foundation::IAsyncOperation<audioSetVolumeResult^>^ SetVolumeAsync(_In_ int64 value);

    // Used to send signals or register functions to handle received signals.
    property audioSignals^ Signals
    {
        audioSignals^ get() { return m_signals; }
    }

    // This event will fire whenever the consumer loses the session that it is a member of.
    virtual event Windows::Foundation::TypedEventHandler<audioConsumer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;

    // This event will fire whenever a member joins the session.
    virtual event Windows::Foundation::TypedEventHandler<audioConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;

    // This event will fire whenever a member leaves the session.
    virtual event Windows::Foundation::TypedEventHandler<audioConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
