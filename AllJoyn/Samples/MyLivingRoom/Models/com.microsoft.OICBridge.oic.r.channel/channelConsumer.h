...
public interface class IchannelConsumer
{
    event Windows::Foundation::TypedEventHandler<channelConsumer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;
    event Windows::Foundation::TypedEventHandler<channelConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;
    event Windows::Foundation::TypedEventHandler<channelConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
    event Windows::Foundation::TypedEventHandler<channelConsumer^, Platform::Object^>^ ChannelUpDownChanged;
};

public ref class channelConsumer sealed  : [Windows::Foundation::Metadata::Default] IchannelConsumer
{
public:
    channelConsumer(Windows::Devices::AllJoyn::AllJoynBusAttachment^ busAttachment);
    ...
    static Windows::Foundation::IAsyncOperation<channelJoinSessionResult^>^ JoinSessionAsync(_In_ Windows::Devices::AllJoyn::AllJoynServiceInfo^ serviceInfo, _Inout_ channelWatcher^ watcher);

    // This event fires whenever the value of ChannelUpDown changes.
    virtual event Windows::Foundation::TypedEventHandler<channelConsumer^, Platform::Object^>^ ChannelUpDownChanged;
    
    // Get the value of the ChannelUpDown property.
    Windows::Foundation::IAsyncOperation<channelGetChannelUpDownResult^>^ GetChannelUpDownAsync();

    // Set the value of the ChannelUpDown property.
    Windows::Foundation::IAsyncOperation<channelSetChannelUpDownResult^>^ SetChannelUpDownAsync(_In_ Platform::String^ value);
    ...
    virtual event Windows::Foundation::TypedEventHandler<channelConsumer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;

    // This event will fire whenever a member joins the session.
    virtual event Windows::Foundation::TypedEventHandler<channelConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;

    // This event will fire whenever a member leaves the session.
    virtual event Windows::Foundation::TypedEventHandler<channelConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
