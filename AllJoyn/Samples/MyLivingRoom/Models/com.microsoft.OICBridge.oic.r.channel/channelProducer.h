...
extern PCSTR c_channelIntrospectionXml;

ref class channelProducer;

public interface class IchannelProducer
{
    event Windows::Foundation::TypedEventHandler<channelProducer^, Windows::Devices::AllJoyn::AllJoynProducerStoppedEventArgs^>^ Stopped;
    event Windows::Foundation::TypedEventHandler<channelProducer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;
    event Windows::Foundation::TypedEventHandler<channelProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;
    event Windows::Foundation::TypedEventHandler<channelProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
};

public ref class channelProducer sealed : [Windows::Foundation::Metadata::Default] IchannelProducer
{
public:
    channelProducer(Windows::Devices::AllJoyn::AllJoynBusAttachment^ busAttachment);
    virtual ~channelProducer();

    // The implementation of IchannelService that will handle method calls and property requests.
    property IchannelService^ Service
    {
        IchannelService^ get() { return m_serviceInterface; }
        void set(IchannelService^ value) { m_serviceInterface = value; }
    }

    // Used to send signals or register functions to handle received signals.
    property channelSignals^ Signals
    {
        channelSignals^ get() { return m_signals; }
    }
    
    // This event will fire whenever this producer is stopped.
    virtual event Windows::Foundation::TypedEventHandler<channelProducer^, Windows::Devices::AllJoyn::AllJoynProducerStoppedEventArgs^>^ Stopped;
    
    // This event will fire whenever the producer loses the session that it created.
    virtual event Windows::Foundation::TypedEventHandler<channelProducer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;
    
    // This event will fire whenever a member joins the session.
    virtual event Windows::Foundation::TypedEventHandler<channelProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;

    // This event will fire whenever a member leaves the session.
    virtual event Windows::Foundation::TypedEventHandler<channelProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;

    // Send a signal to all members of the session to notify them that the value of ChannelUpDown has changed.
    void EmitChannelUpDownChanged();
...
private:
    ...
    channelSignals^ m_signals;
    IchannelService^ m_serviceInterface;
