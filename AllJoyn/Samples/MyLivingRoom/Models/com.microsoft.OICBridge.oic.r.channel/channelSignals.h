...
ref class channelSignals;

public interface class IchannelSignals
{
};

public ref class channelSignals sealed : [Windows::Foundation::Metadata::Default] IchannelSignals
{
public:
internal:
