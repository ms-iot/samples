...
void interface_1Watcher::UnregisterFromBus()
{
    ...
    {
        PCSTR interfaces[] = { "com.enocean.Bridge.RockerButton.interface_1" };
    ...
    _In_ const alljoyn_msgarg aboutDataArg)
{
    ...
    if (alljoyn_aboutobjectdescription_hasinterface(objectDescription, "com.enocean.Bridge.RockerButton.interface_1"))
    {
        AllJoynServiceInfo^ args = ref new AllJoynServiceInfo(
            AllJoynHelpers::MultibyteToPlatformString(name),
            AllJoynHelpers::GetObjectPath(objectDescription, "com.enocean.Bridge.RockerButton.interface_1"),
            port);
        Added(this, args);
    }
