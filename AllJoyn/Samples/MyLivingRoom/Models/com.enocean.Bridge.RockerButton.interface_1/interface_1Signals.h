...
ref class interface_1Signals;

public interface class Iinterface_1Signals
{
};

public ref class interface_1Signals sealed : [Windows::Foundation::Metadata::Default] Iinterface_1Signals
{
public:
internal:
