...
public interface class IControlPanelConsumer
{
    event Windows::Foundation::TypedEventHandler<ControlPanelConsumer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;
    event Windows::Foundation::TypedEventHandler<ControlPanelConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;
    event Windows::Foundation::TypedEventHandler<ControlPanelConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
};

public ref class ControlPanelConsumer sealed  : [Windows::Foundation::Metadata::Default] IControlPanelConsumer
{
public:
    ControlPanelConsumer(Windows::Devices::AllJoyn::AllJoynBusAttachment^ busAttachment);
    virtual ~ControlPanelConsumer();
    ...
    static Windows::Foundation::IAsyncOperation<ControlPanelJoinSessionResult^>^ JoinSessionAsync(_In_ Windows::Devices::AllJoyn::AllJoynServiceInfo^ serviceInfo, _Inout_ ControlPanelWatcher^ watcher);

    // Get the value of the Version property.
    Windows::Foundation::IAsyncOperation<ControlPanelGetVersionResult^>^ GetVersionAsync();
    ...
    virtual event Windows::Foundation::TypedEventHandler<ControlPanelConsumer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;

    // This event will fire whenever a member joins the session.
    virtual event Windows::Foundation::TypedEventHandler<ControlPanelConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;

    // This event will fire whenever a member leaves the session.
    virtual event Windows::Foundation::TypedEventHandler<ControlPanelConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
