...
IAsyncOperation<int>^ PropertyConsumer::SetValueAsync(_In_ Platform::Object^ value)
{
    return create_async([this, value]() -> int
    {
        ...
        TypeConversionHelpers::SetAllJoynMessageArg(inputArgument, "v", value);
...
int32 PropertyConsumer::JoinSession(_In_ AllJoynServiceInfo^ serviceInfo)
{
    ...
    RETURN_IF_QSTATUS_ERROR(AllJoynHelpers::CreateBusObject<PropertyConsumer>(m_weak));

    alljoyn_interfacedescription description = alljoyn_busattachment_getinterface(AllJoynHelpers::GetInternalBusAttachment(m_busAttachment), "org.alljoyn.ControlPanel.Property");
