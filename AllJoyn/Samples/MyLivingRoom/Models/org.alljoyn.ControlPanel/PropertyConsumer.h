...
public interface class IPropertyConsumer
{
    event Windows::Foundation::TypedEventHandler<PropertyConsumer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;
    event Windows::Foundation::TypedEventHandler<PropertyConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;
    event Windows::Foundation::TypedEventHandler<PropertyConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
};

public ref class PropertyConsumer sealed  : [Windows::Foundation::Metadata::Default] IPropertyConsumer
{
public:
    PropertyConsumer(Windows::Devices::AllJoyn::AllJoynBusAttachment^ busAttachment);
    virtual ~PropertyConsumer();
    ...
    static Windows::Foundation::IAsyncOperation<PropertyJoinSessionResult^>^ JoinSessionAsync(_In_ Windows::Devices::AllJoyn::AllJoynServiceInfo^ serviceInfo, _Inout_ PropertyWatcher^ watcher);

    // Get the value of the Version property.
    Windows::Foundation::IAsyncOperation<PropertyGetVersionResult^>^ GetVersionAsync();

    // Get the value of the States property.
    Windows::Foundation::IAsyncOperation<PropertyGetStatesResult^>^ GetStatesAsync();

    // Get the value of the OptParams property.
    Windows::Foundation::IAsyncOperation<PropertyGetOptParamsResult^>^ GetOptParamsAsync();

    // Get the value of the Value property.
    Windows::Foundation::IAsyncOperation<PropertyGetValueResult^>^ GetValueAsync();

    // Set the value of the Value property.
    Windows::Foundation::IAsyncOperation<int>^ SetValueAsync(_In_ Platform::Object^ value);
    ...
    virtual event Windows::Foundation::TypedEventHandler<PropertyConsumer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;

    // This event will fire whenever a member joins the session.
    virtual event Windows::Foundation::TypedEventHandler<PropertyConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;

    // This event will fire whenever a member leaves the session.
    virtual event Windows::Foundation::TypedEventHandler<PropertyConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
