...
extern PCSTR c_airflowIntrospectionXml;

ref class airflowProducer;

public interface class IairflowProducer
{
    event Windows::Foundation::TypedEventHandler<airflowProducer^, Windows::Devices::AllJoyn::AllJoynProducerStoppedEventArgs^>^ Stopped;
    event Windows::Foundation::TypedEventHandler<airflowProducer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;
    event Windows::Foundation::TypedEventHandler<airflowProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;
    event Windows::Foundation::TypedEventHandler<airflowProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
};

public ref class airflowProducer sealed : [Windows::Foundation::Metadata::Default] IairflowProducer
{
public:
    airflowProducer(Windows::Devices::AllJoyn::AllJoynBusAttachment^ busAttachment);
    virtual ~airflowProducer();

    // The implementation of IairflowService that will handle method calls and property requests.
    property IairflowService^ Service
    {
        IairflowService^ get() { return m_serviceInterface; }
        void set(IairflowService^ value) { m_serviceInterface = value; }
    }
    ...
    virtual event Windows::Foundation::TypedEventHandler<airflowProducer^, Windows::Devices::AllJoyn::AllJoynProducerStoppedEventArgs^>^ Stopped;
    
    // This event will fire whenever the producer loses the session that it created.
    virtual event Windows::Foundation::TypedEventHandler<airflowProducer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;
    
    // This event will fire whenever a member joins the session.
    virtual event Windows::Foundation::TypedEventHandler<airflowProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;

    // This event will fire whenever a member leaves the session.
    virtual event Windows::Foundation::TypedEventHandler<airflowProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;

    // Send a signal to all members of the session to notify them that the value of Direction has changed.
    ...
    // Send a signal to all members of the session to notify them that the value of Speed has changed.
    void EmitSpeedChanged();
...
private:
    ...
    IairflowService^ m_serviceInterface;
