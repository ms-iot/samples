...
public interface class IairflowConsumer
{
    event Windows::Foundation::TypedEventHandler<airflowConsumer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;
    event Windows::Foundation::TypedEventHandler<airflowConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;
    event Windows::Foundation::TypedEventHandler<airflowConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
    event Windows::Foundation::TypedEventHandler<airflowConsumer^, Platform::Object^>^ DirectionChanged;
    event Windows::Foundation::TypedEventHandler<airflowConsumer^, Platform::Object^>^ RangeChanged;
    event Windows::Foundation::TypedEventHandler<airflowConsumer^, Platform::Object^>^ SpeedChanged;
};

public ref class airflowConsumer sealed  : [Windows::Foundation::Metadata::Default] IairflowConsumer
{
public:
    airflowConsumer(Windows::Devices::AllJoyn::AllJoynBusAttachment^ busAttachment);
    virtual ~airflowConsumer();
    ...
    static Windows::Foundation::IAsyncOperation<airflowJoinSessionResult^>^ JoinSessionAsync(_In_ Windows::Devices::AllJoyn::AllJoynServiceInfo^ serviceInfo, _Inout_ airflowWatcher^ watcher);

    // This event fires whenever the value of Direction changes.
    virtual event Windows::Foundation::TypedEventHandler<airflowConsumer^, Platform::Object^>^ DirectionChanged;
    
    // Get the value of the Direction property.
    Windows::Foundation::IAsyncOperation<airflowGetDirectionResult^>^ GetDirectionAsync();

    // Set the value of the Direction property.
    Windows::Foundation::IAsyncOperation<airflowSetDirectionResult^>^ SetDirectionAsync(_In_ Platform::String^ value);
    // This event fires whenever the value of Range changes.
    virtual event Windows::Foundation::TypedEventHandler<airflowConsumer^, Platform::Object^>^ RangeChanged;
    
    // Get the value of the Range property.
    Windows::Foundation::IAsyncOperation<airflowGetRangeResult^>^ GetRangeAsync();

    // Set the value of the Range property.
    Windows::Foundation::IAsyncOperation<airflowSetRangeResult^>^ SetRangeAsync(_In_ Platform::String^ value);
    // This event fires whenever the value of Speed changes.
    virtual event Windows::Foundation::TypedEventHandler<airflowConsumer^, Platform::Object^>^ SpeedChanged;
    
    // Get the value of the Speed property.
    Windows::Foundation::IAsyncOperation<airflowGetSpeedResult^>^ GetSpeedAsync();

    // Set the value of the Speed property.
    Windows::Foundation::IAsyncOperation<airflowSetSpeedResult^>^ SetSpeedAsync(_In_ int64 value);

    // Used to send signals or register functions to handle received signals.
    property airflowSignals^ Signals
    {
        airflowSignals^ get() { return m_signals; }
    }

    // This event will fire whenever the consumer loses the session that it is a member of.
    virtual event Windows::Foundation::TypedEventHandler<airflowConsumer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;

    // This event will fire whenever a member joins the session.
    virtual event Windows::Foundation::TypedEventHandler<airflowConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;

    // This event will fire whenever a member leaves the session.
    virtual event Windows::Foundation::TypedEventHandler<airflowConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
