...
ref class airflowSignals;

public interface class IairflowSignals
{
};

public ref class airflowSignals sealed : [Windows::Foundation::Metadata::Default] IairflowSignals
{
public:
internal:
