...
QStatus interface_1Producer::OnPropertyGet(_In_ PCSTR interfaceName, _In_ PCSTR propertyName, _Inout_ alljoyn_msgarg value)
{
    ...
    if (0 == strcmp(propertyName, "Contact"))
    {
        auto task = create_task(Service->GetContactAsync(nullptr));
        ...
        return create_task([](){}).then([=]() -> QStatus
        {
            ...
            return static_cast<QStatus>(TypeConversionHelpers::SetAllJoynMessageArg(value, "s", result->Contact));
...
void interface_1Producer::EmitContactChanged()
{
    create_task([&]
    {
        alljoyn_msgarg value = alljoyn_msgarg_create();
        OnPropertyGet("com.enocean.Bridge.WindowContact.interface_1", "Contact", value);

        alljoyn_busobject_emitpropertychanged(
            m_busObject,
            "com.enocean.Bridge.WindowContact.interface_1",
            "Contact",
            value,
            m_sessionId);
...
void interface_1Producer::Start()
{
    ...
    alljoyn_interfacedescription interfaceDescription = alljoyn_busattachment_getinterface(AllJoynHelpers::GetInternalBusAttachment(m_busAttachment), "com.enocean.Bridge.WindowContact.interface_1");
...
PCSTR com::enocean::Bridge::WindowContact::interface_1::c_interface_1IntrospectionXml = "<interface name=\"com.enocean.Bridge.WindowContact.interface_1\">"
"  <property name=\"Contact\" type=\"s\" access=\"read\">"
