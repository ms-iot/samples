...
extern PCSTR c_binaryIntrospectionXml;

ref class binaryProducer;

public interface class IbinaryProducer
{
    event Windows::Foundation::TypedEventHandler<binaryProducer^, Windows::Devices::AllJoyn::AllJoynProducerStoppedEventArgs^>^ Stopped;
    event Windows::Foundation::TypedEventHandler<binaryProducer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;
    event Windows::Foundation::TypedEventHandler<binaryProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;
    event Windows::Foundation::TypedEventHandler<binaryProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
};

public ref class binaryProducer sealed : [Windows::Foundation::Metadata::Default] IbinaryProducer
{
public:
    binaryProducer(Windows::Devices::AllJoyn::AllJoynBusAttachment^ busAttachment);
    virtual ~binaryProducer();

    // The implementation of IbinaryService that will handle method calls and property requests.
    property IbinaryService^ Service
    {
        IbinaryService^ get() { return m_serviceInterface; }
        void set(IbinaryService^ value) { m_serviceInterface = value; }
    }

    // Used to send signals or register functions to handle received signals.
    property binarySignals^ Signals
    {
        binarySignals^ get() { return m_signals; }
    }
    
    // This event will fire whenever this producer is stopped.
    virtual event Windows::Foundation::TypedEventHandler<binaryProducer^, Windows::Devices::AllJoyn::AllJoynProducerStoppedEventArgs^>^ Stopped;
    
    // This event will fire whenever the producer loses the session that it created.
    virtual event Windows::Foundation::TypedEventHandler<binaryProducer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;
    
    // This event will fire whenever a member joins the session.
    virtual event Windows::Foundation::TypedEventHandler<binaryProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;

    // This event will fire whenever a member leaves the session.
    virtual event Windows::Foundation::TypedEventHandler<binaryProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
...
private:
    ...
    binarySignals^ m_signals;
    IbinaryService^ m_serviceInterface;
