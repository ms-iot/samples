...
public interface class IbinaryConsumer
{
    event Windows::Foundation::TypedEventHandler<binaryConsumer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;
    event Windows::Foundation::TypedEventHandler<binaryConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;
    event Windows::Foundation::TypedEventHandler<binaryConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
    event Windows::Foundation::TypedEventHandler<binaryConsumer^, Platform::Object^>^ ValueChanged;
};

public ref class binaryConsumer sealed  : [Windows::Foundation::Metadata::Default] IbinaryConsumer
{
public:
    binaryConsumer(Windows::Devices::AllJoyn::AllJoynBusAttachment^ busAttachment);
    virtual ~binaryConsumer();
    ...
    static Windows::Foundation::IAsyncOperation<binaryJoinSessionResult^>^ JoinSessionAsync(_In_ Windows::Devices::AllJoyn::AllJoynServiceInfo^ serviceInfo, _Inout_ binaryWatcher^ watcher);

    // This event fires whenever the value of Value changes.
    virtual event Windows::Foundation::TypedEventHandler<binaryConsumer^, Platform::Object^>^ ValueChanged;
    
    // Get the value of the Value property.
    Windows::Foundation::IAsyncOperation<binaryGetValueResult^>^ GetValueAsync();

    // Set the value of the Value property.
    Windows::Foundation::IAsyncOperation<binarySetValueResult^>^ SetValueAsync(_In_ bool value);
    ...
    virtual event Windows::Foundation::TypedEventHandler<binaryConsumer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;

    // This event will fire whenever a member joins the session.
    virtual event Windows::Foundation::TypedEventHandler<binaryConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;

    // This event will fire whenever a member leaves the session.
    virtual event Windows::Foundation::TypedEventHandler<binaryConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
