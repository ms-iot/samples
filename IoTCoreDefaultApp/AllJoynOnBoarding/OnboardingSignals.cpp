...
void OnboardingSignals::ConnectionResult(_In_ OnboardingResult^ interfaceMemberResult)
{
    ...
    TypeConversionHelpers::SetAllJoynMessageArg(alljoyn_msgarg_array_element(arguments, 0), "(ns)", interfaceMemberResult);
