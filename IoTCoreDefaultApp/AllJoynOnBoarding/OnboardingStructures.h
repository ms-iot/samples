...
public ref class OnboardingResult sealed
{
public:
...
{
internal:
    static _Check_return_ int32 GetAllJoynMessageArg(_In_ alljoyn_msgarg argument, _In_ PCSTR signature, _Out_ org::alljoyn::OnboardingScanListItem^* value)
    {
        UNREFERENCED_PARAMETER(signature);

        (*value) = ref new org::alljoyn::OnboardingScanListItem();
    ...
    static _Check_return_ int32 SetAllJoynMessageArg(_In_ alljoyn_msgarg argument, _In_ PCSTR signature, _In_ org::alljoyn::OnboardingScanListItem^ value)
    {
        UNREFERENCED_PARAMETER(signature);
    ...
    static _Check_return_ int32 GetAllJoynMessageArg(_In_ alljoyn_msgarg argument, _In_ PCSTR signature, _Out_ org::alljoyn::OnboardingResult^* value)
    {
        UNREFERENCED_PARAMETER(signature);

        (*value) = ref new org::alljoyn::OnboardingResult();
    ...
    static _Check_return_ int32 SetAllJoynMessageArg(_In_ alljoyn_msgarg argument, _In_ PCSTR signature, _In_ org::alljoyn::OnboardingResult^ value)
    {
        UNREFERENCED_PARAMETER(signature);
    ...
    static _Check_return_ int32 GetAllJoynMessageArg(_In_ alljoyn_msgarg argument, _In_ PCSTR signature, _Out_ org::alljoyn::OnboardingLastError^* value)
    {
        UNREFERENCED_PARAMETER(signature);

        (*value) = ref new org::alljoyn::OnboardingLastError();
    ...
    static _Check_return_ int32 SetAllJoynMessageArg(_In_ alljoyn_msgarg argument, _In_ PCSTR signature, _In_ org::alljoyn::OnboardingLastError^ value)
    {
        UNREFERENCED_PARAMETER(signature);
