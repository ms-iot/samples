...
public:
    ...
    property OnboardingResult^ Result
    {
        OnboardingResult^ get() { return m_interfaceMemberResult; }
    internal:
        void set(_In_ OnboardingResult^ value) { m_interfaceMemberResult = value; }
    }

private:
    Windows::Devices::AllJoyn::AllJoynMessageInfo^ m_messageInfo;

    OnboardingResult^ m_interfaceMemberResult;
};
