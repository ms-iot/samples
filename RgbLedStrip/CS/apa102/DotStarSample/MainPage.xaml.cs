...
namespace DotStarSample
{
    ...
    {
        private DotStarStrip pixelStrip;
        ...
        /// <summary>
        /// Initialize the strip once the page is loaded
        /// </summary>
        ...
        /// <summary>
        /// When the fancy colors button gets toggled off, signal an exit to the task driving the animation
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
